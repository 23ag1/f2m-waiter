  ...
  return (
    <div data-tour="hint-strip" className="bg-inset/60 border-t border-hair-soft">
      ...
      >
        ...
        <span className="text-xs font-bold text-ink-muted uppercase tracking-wide">Рекомендации гостю</span>
        <span className="ml-auto flex items-center gap-1 text-ink-subtle">
          {collapsed && <span className="text-xs font-semibold">{ordered.length}</span>}
